...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default=os.path.join(parent_dir, 'Datasets/TSB-AD-M/'))
    parser.add_argument('--file_lsit', type=str, default=os.path.join(parent_dir, 'Datasets/File_List/TSB-AD-M-Tuning.csv'))
    parser.add_argument('--save_dir', type=str, default=os.path.join(parent_dir, 'eval/HP_tuning/multi/'))
    parser.add_argument('--AD_Name', type=str, default='AxonAD')
